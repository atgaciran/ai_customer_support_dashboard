...
export function ThemeToggle() {
  ...
  // Hydration hatasını önlemek için bileşenin yüklenip yüklenmediğini kontrol ediyoruz
  const [mounted, setMounted] = useState(false);

  useEffect(() => {
    // State güncellemesini senkron olmaktan çıkarıp, React'in render
    // döngüsünü bozmamak için mikrosaniyelik bir gecikmeyle (asenkron) yapıyoruz.
